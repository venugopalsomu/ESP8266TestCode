...
//global variables:
#define RELAY_PIN_1  14  // Arduino Digital I/O pin number for relay (ESP8266)
#define BUTTON_PIN_1  4  // Arduino Digital I/O pin number for button 
#define RELAY_PIN_2  12  // Arduino Digital I/O pin number for relay (ESP8266)
#define BUTTON_PIN_2  5  // Arduino Digital I/O pin number for button 
#define RELAY_PIN_3  13  // Arduino Digital I/O pin number for relay (ESP8266)
#define BUTTON_PIN_3  0  // (Default Pull High) Arduino Digital I/O pin number for button 
...
#define EEPROM_RELAY_ADDRESS_1 3
#define EEPROM_SWITCH_ADDRESS_1 4
#define EEPROM_MQTT_ADDRESS_1 5

#define EEPROM_RELAY_ADDRESS_2 6
#define EEPROM_SWITCH_ADDRESS_2 7
#define EEPROM_MQTT_ADDRESS_2 8
...
static struct wifiSwitchStatus SwitchStatus[3];
...
void initHwPins()
{
  ...
  SwitchStatus[1].swithcPinNum = BUTTON_PIN_2;
  SwitchStatus[1].RelayPinNum = RELAY_PIN_2;
  SwitchStatus[2].swithcPinNum = BUTTON_PIN_3;
  SwitchStatus[2].RelayPinNum = RELAY_PIN_3;
  ...
  SwitchStatus[1].eepromRelayAddress = EEPROM_RELAY_ADDRESS_1;
  SwitchStatus[1].eepromSwitchAddress = EEPROM_SWITCH_ADDRESS_1;
  SwitchStatus[1].eepromMqttAddress = EEPROM_MQTT_ADDRESS_1;

  SwitchStatus[2].eepromRelayAddress = EEPROM_RELAY_ADDRESS_2;
  SwitchStatus[2].eepromSwitchAddress = EEPROM_SWITCH_ADDRESS_2;
  SwitchStatus[2].eepromMqttAddress = EEPROM_MQTT_ADDRESS_2;
